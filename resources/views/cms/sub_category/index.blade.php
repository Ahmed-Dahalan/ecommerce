    ...
    <section class="content">
        <div class="row">
            <div class="col-8">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Sub Category List <span class="badge badge-pill badge-danger"> {{ count($subcategories) }} </span></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn btn-danger"
                                                onclick="confirmDelete('{{$subcategory->id}}',this)"><i
            ...
            <div class="col-4">
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Add Sub Ctegory  </span></h3>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <h5>Sub Category Name Engish <span class="text-danger"></span></h5>
                                                <div class="controls">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-group">
                                                <h5>Sub Category Name Arabic<span class="text-danger"></span></h5>
                                                <div class="controls">
