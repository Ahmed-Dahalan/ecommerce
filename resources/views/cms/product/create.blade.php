                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_en" required id="textarea" class="form-control"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_ar" required id="textarea" class="form-control"
                                                        required placeholder="Textarea text"></textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea id="editor2" required name="long_descp_ar" rows="10" cols="80">
