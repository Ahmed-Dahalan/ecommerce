                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_en" value="{{ $products->product_tags_en }}" class="form-control"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" name="product_tags_ar" value="{{ $products->product_tags_ar }}" class="form-control"
                                                         data-role="tagsinput" required="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_en" id="textarea" class="form-control"
                                                        required placeholder="Textarea text">{!! $products->short_descp_en !!}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <textarea name="short_descp_ar" id="textarea" class="form-control"
                                                        required placeholder="Textarea text">{!! $products->short_descp_ar !!}</textarea>
                                                </div>
                                            </div>
...
<script type="text/javascript">
 ...
 $('select[name="subcategory_id"]').on('change', function(){
            ...
            if(subcategory_id) {
                $.ajax({
                    url: "{{  url('/cms/sub-subcategory/ajax') }}/"+subcategory_id,
                    type:"GET",
                    dataType:"json",
                    success:function(data) {
