        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
               ...
               @include('frontend.common.vertical_menue')
                                            ...
                                            <div class="row product-micro-row">
                                                <div class="col col-xs-5">
                                                    <div class="product-image">
                                                        <div class="image"> <a
                                                                href="{{ url('shop/product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                ...
                                                <div class="col col-xs-7">
                                                    <div class="product-info">
                                                        <h3 class="name"><a
                                                                href="{{ url('shop/product/details/'.$product->id.'/'.$product->product_slug_en ) }}">@if(session()->get('language')
                                                                == 'arabic') {{ $product->product_name_ar }} @else {{
                ...
                <!-- ============================================== Testimonials============================================== -->
                @include('frontend.common.testmonil')
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 homebanner-holder">
                                    ...
                                    <div class="item item-carousel">
                                        <div class="products">
                                            <div class="product">
                                                <div class="product-image">
                                                    <div class="image"> <a
                                                            href="{{ url('shop/product/details/'.$product->id.'/'.$product->product_slug_en ) }}"><img
                        ...
                        <div class="tab-pane" id="category{{ $category->id }}">
                            <div class="product-slider">
                                <div class="owl-carousel home-owl-carousel custom-carousel owl-theme">
                                    ...
                                    <!-- /.item -->
                                    @empty
                                    <span class="text-danger">No Found Product</span>
                                    @endforelse
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'hindi') {{ $skip_category_0->category_name_hin }} @else {{
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'arabic') {{ $skip_category_1->category_name_ar }} @else {{
                            ...
                            <div class="products">
                                <div class="product">
                                    ...
                                    <div class="product-info text-left">
                                        <h3 class="name"><a
                                                href="{{ url('shop/product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                @if(session()->get('language') == 'arabic') {{ $product->product_name_ar }} @else {{
                                                $product->product_name_en }} @endif
                                            </a></h3>
                                        <div class="rating rateit-small"></div>
                                        <div class="description"></div>
                ...
                <section class="section featured-product wow fadeInUp">
                    <h3 class="section-title">
                        @if(session()->get('language') == 'arabic') {{ $skip_brand_1->brand_name_ar }} @else {{
                            ...
                            <div class="item">
                                <div class="blog-post">
                                    ...
                                    <div class="blog-post-info text-left">
                                        <h3 class="name"><a href="#">@if(session()->get('language') == 'arabic') {{ $blog->post_title_ar }} @else {{
                                                $blog->post_title_en }} @endif</a></h3>
                                        
                                        
                                        <span class="info">{{ Carbon\Carbon::parse($blog->created_at)->diffForHumans() }}</span>
                                        
                                        <p class="text">@if(session()->get('language') == 'arabic') {!! Str::limit($blog->post_details_ar, 100 ) !!} @else {!!
                                            Str::limit($blog->post_details_en, 100 ) !!} @endif</p>
