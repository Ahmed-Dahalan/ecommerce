                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading">
                                            ...
                                            <label class="form-check-label">
                                                <input type="checkbox" class="form-check-input" name="category[]" @if(!empty($filterCat) && in_array($category->category_slug_en,$filterCat)) checked @endif value="{{ $category->category_slug_en }}"
                                ...
                                <div class="accordion-group">
                                    <div class="accordion-heading">
                                        ...
                                        <label class="form-check-label">
                                            ...
                                            @if(session()->get('language') == 'hindi') {{ $brand->brand_name_hin }} @else {{
