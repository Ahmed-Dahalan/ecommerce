...
<div class="sidebar-widget product-tag wow fadeInUp">
    ...
    <div class="sidebar-widget-body outer-top-xs">
        ...
        <div class="tag-list">
            ...
            <a class="item active" title="Phone" href="{{ url('shop/product/tag/'.$tag->product_tags_ar) }}">
            ...
            <a class="item active" title="Phone" href="{{ url('shop/product/tag/'.$tag->product_tags_en) }}">
