            ...
            <div class='col-md-3 sidebar'>
                ...
                <div class="sidebar-module-container">
                    <div class="sidebar-filter">
                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading"> <a href="#collapse{{ $category->id }}" data-toggle="collapse"
                                                ...
                                                @if(session()->get('language') == 'arabic') {{ $category->category_name_ar }} @else {{
                                        ...
                                        <div class="accordion-body collapse" id="collapse{{ $category->id }}" style="height: 0px;">
                                            <div class="accordion-inner">
                                                ...
                                                <ul>
                                                    <li><a href="#">
                                                            @if(session()->get('language') == 'arabic') {{ $subcategory->subcategory_name_ar }} @else {{
                        ...
                        <div class="home-banner"> <img src="{{ asset('frontend/assets/images/banners/cat-banner.jpg') }}" alt="Image"> </div>
                    </div>
                    <!-- /.sidebar-filter -->
                </div>
                                    ...
                                    <div class="products">
                                        <div class="product">
                                            ...
                                            <div class="product-info text-left">
                                                <h3 class="name"><a href="{{ url('shop/product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                            ...
                                            <div class="row product-list-row">
                                                ...
                                                <div class="col col-sm-8 col-lg-8">
                                                    <div class="product-info">
                                                        <h3 class="name"><a href="{{ url('shop/product/details/'.$product->id.'/'.$product->product_slug_en ) }}">
                                                                @if(session()->get('language') == 'hindi') {{ $product->product_name_hin }} @else {{ $product->product_name_en
                                                                }} @endif</a></h3>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        @if ($product->discount_price == NULL)
                                                        ...
                                                        <div class="description m-t-10">
                                                            @if(session()->get('language') == 'arabic') {{ $product->short_descp_ar }} @else {{ $product->short_descp_en }}
                                                            @endif</div>
                                                        <div class="cart clearfix animate-effect">
                                                            <div class="action">
                                                                <ul class="list-unstyled">
