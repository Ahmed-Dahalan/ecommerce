                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="col-md-1">
                                    <a href="{{ url('shop/order_details/'.$order->id ) }}" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i> View</a>
            
                                    <a target="_blank" href="{{ url('shop/invoice_download/'.$order->id ) }}" class="btn btn-sm btn-danger"><i class="fa fa-download" style="color: white;"></i>
                                        Invoice </a>
