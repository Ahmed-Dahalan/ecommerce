    ...
    <div class='container'>
        <div class='row'>
                                ...
                                <div class="accordion">
                                    ...
                                    <div class="accordion-group">
                                        <div class="accordion-heading"> <a href="#collapse{{ $category->id }}"
                                                ...
                                                $category->category_name_hin }} @else {{ $category->category_name_en }}
                                                @endif </a> </div>
                                        <!-- /.accordion-heading -->
            ...
            <div class='col-md-9'>
                ...
                <h4><b>Total Search </b><span class="badge badge-danger" style="background: #FF0000;"> {{ count($products) }} </span>
                    Items </h4>
