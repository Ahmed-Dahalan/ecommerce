            ...
            <div class="blog-page">
                <div class="col-md-9">
                    ...
                    <div class="blog-post  wow fadeInUp">
                        ...
                        <h1><a href="blog-details.html"> @if(session()->get('language') == 'arabic') {{ $blog->post_title_ar }} @else {{
                                $blog->post_title_en }} @endif</a></h1>
                        
                        <span class="date-time"> {{ Carbon\Carbon::parse($blog->created_at)->diffForHumans() }}</span>
                        
                        <p>@if(session()->get('language') == 'arabic') {!! Str::limit($blog->post_details_ar, 200 ) !!} @else {!!
                            Str::limit($blog->post_details_en, 200 ) !!} @endif</p>
                        ...
                        <div class="sidebar-widget outer-bottom-xs wow fadeInUp">
                            ...
                            <div class="sidebar-widget-body m-t-10">
                                <div class="accordion">
                                    ...
                                    <ul class="list-group">
                                        <a href="{{ url('shop/blog/category/post/'.$category->id) }}"><li class="list-group-item">@if(session()->get('language') == 'arabic') {{ $category->blog_category_name_ar }} @else
                                            {{ $category->blog_category_name_en }} @endif</li></a>
